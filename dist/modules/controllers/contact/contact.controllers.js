...
exports.patchContactController = exports.getContactAllController = exports.getContactController = void 0;
...
exports.getContactAllController = (0, error_services_1.default)(async (req, res) => {
    const response = await contact_services_1.default.getContactAll(req.lang ?? "en");
    res.status(response.status).json(response);
});
