...
exports.updateStudioWhyUsController = exports.updateStudioPartnersController = exports.updateStudioAboutController = exports.updateStudioHeroController = exports.getStudioAllController = exports.getStudioWhyUsController = exports.getStudioPartnersController = exports.getStudioAboutController = exports.getStudioHeroController = void 0;
...
exports.getStudioAllController = (0, error_services_1.default)(async (req, res) => {
    const response = await studio_services_1.default.getStudioAll(req.lang ?? "en");
    res.status(response.status).json(response);
});
